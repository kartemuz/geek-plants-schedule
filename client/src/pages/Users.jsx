  ...
  const [idTeacher, setIdTeacher] = React.useState(0);
    ...
    React.useEffect(() => {
      if(isLoading){
          ...
          await axios.get(`${apiServer}/users/get`).then((response) => {
      ...
      return (
        <div className="flex flex-col gap-5">
          ...
          <div className="flex justify-between items-center">
            ...
            >
              <option value={users.length}>Все</option>
    ...
    return (
      <>
      <div className="px-[20px] text-[32px] font-bold tableName">Поьзователи</div>
